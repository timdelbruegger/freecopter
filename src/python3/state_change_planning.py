...
class StateChangeSelectTimeToReachTarget:
    ...
    def inSeconds(self, timeToReachTargetState):
        ...
        c =               curSpd
        d =    curVal
        plan = StateChangePlan(a, b, c, d, timeToReachTargetState)
...
class State:
    def __init__(self, value, speed):
        ...
        self.speed = speed # the speed with which the value changes over time
...
class StateChangePlan:
    def __init__(self, a, b, c, d, timeToReachTargetState):
        coef = [d, c, b, a]
        self._plan = Polynomial(coef)
        self._timeunit = timeToReachTargetState
...
#        return polyval(t/self.timeunit, coef)
    ...
    def calculateTargetSpeedForTimePeriod(self, t_begin, t_end):

        return (self.valueAt(t_end)-self.valueAt(t_begin)) / self._timeunit
